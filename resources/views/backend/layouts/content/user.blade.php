              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="Email" required data-parsley-type="email" data-parsley-trigger="keyup">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Address</label>
                        <input type="text" class="form-control" placeholder="Home Address" required data-parsley-trigger="keyup" data-parsley-length="[8, 40]" data-parsley-group="block2">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" placeholder="Here can be your description"  required data-parsley-trigger="keyup" data-parsley-length="[8, 100]" data-parsley-group="block2"></textarea>
                      </div>
                    </div>
                  </div>
                </form>
                ...
                <p class="card-text">
                  <div class="author">
                    ...
                    <a href="javascript:void(0)">
                      <img class="avatar" src="{{ Voyager::image(Auth::user()->avatar) }}" alt="...">
